 ...
 *
 */
public class TextSameLineDiffAppController {

	private static Logger LOGGER = LoggerFactory.getLogger(TextSameLineDiffAppController.class);
	...
	public TextSameLineDiffAppController() {
