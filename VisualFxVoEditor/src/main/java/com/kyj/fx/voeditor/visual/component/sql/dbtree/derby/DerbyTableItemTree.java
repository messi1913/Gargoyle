 ...
 *
 */
public class DerbyTableItemTree extends TableItemTree<String> {

	private String tableId;

	public DerbyTableItemTree(SchemaItemTree<String> parent, String name) throws Exception {
		super(parent, name);
	}
	...
	public ObservableList<TreeItem<DatabaseItemTree<String>>> applyChildren(Connection con, String... args) throws Exception {
		...
		while (tables.next()) {
			...
			DerbyColumnItemTree coumnItem = new DerbyColumnItemTree(this, columnName);
