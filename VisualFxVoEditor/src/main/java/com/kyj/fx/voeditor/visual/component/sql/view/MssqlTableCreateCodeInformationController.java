 ...
 *
 */
public class MssqlTableCreateCodeInformationController extends CommonTableCreateCodeInformationController {

	
	private static Logger LOGGER = LoggerFactory.getLogger(MssqlTableCreateCodeInformationController.class);

	public MssqlTableCreateCodeInformationController() throws Exception {
		super();
	}
