 ...
 *
 */
public class MYSQLSchemaItemTree extends SchemaItemTree<String> {

	public MYSQLSchemaItemTree(DatabaseItemTree<String> parent, String name) throws Exception {
		super(parent, name);
	}
	...
	public ObservableList<TreeItem<DatabaseItemTree<String>>> applyChildren(List<Map<String, Object>> items) throws Exception {
		...
		for (Map<String, Object> map : items) {
			...
			MYSQLTableItemTree mysqlSchemaItemTree = new MYSQLTableItemTree(this, tableName.toString());
