...
public class CheckBoxFxControlTreeView extends CheckTreeView<Node> {
	 ...
	 *            분석하고자하는 UI노드
	 */
	public CheckBoxFxControlTreeView(Node item) {
	...
	protected Skin<?> createDefaultSkin() {
		return new CheckBoxFxControlTreeViewSkin(this);
	}
