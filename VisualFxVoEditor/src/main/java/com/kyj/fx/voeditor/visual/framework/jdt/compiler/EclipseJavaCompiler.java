 ...
 *
 */
public class EclipseJavaCompiler implements JavaCompilerable {
	 ...
	 * @param value
	 */
	public EclipseJavaCompiler(File src, File dst) {
		this(src, dst, null);
	}

	public EclipseJavaCompiler(File src, File dst, File[] classpaths) {
		this.src = src;
		this.dst = dst;
