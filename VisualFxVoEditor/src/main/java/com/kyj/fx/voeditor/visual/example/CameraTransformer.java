...
public class CameraTransformer extends Group {
	...
	public void transitionCameraTo(double milliseconds, double tx, double ty, double tz, double rx, double ry, double rz) {
		...
		timeline.getKeyFrames().addAll(new KeyFrame[] { new KeyFrame(Duration.millis(milliseconds), new KeyValue[] { // Frame End                 
				new KeyValue(xRotateProperty(), rx, Interpolator.EASE_BOTH), new KeyValue(yRotateProperty(), ry, Interpolator.EASE_BOTH),
				new KeyValue(zRotateProperty(), rz, Interpolator.EASE_BOTH), new KeyValue(xTranslateProperty(), tx, Interpolator.EASE_BOTH),
	...
	public DoubleProperty xRotateProperty() {
		return xRotate;
	}
	...
	public DoubleProperty yRotateProperty() {
		return yRotate;
	}
	...
	public final double getzRotate() {
		return zRotate.get();
	}

	public void setzRotate(double value) {
		zRotate.set(value);
	}

	public DoubleProperty zRotateProperty() {
		return zRotate;
	}
