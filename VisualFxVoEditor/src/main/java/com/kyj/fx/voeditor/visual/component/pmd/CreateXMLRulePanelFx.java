 ...
 */
public class CreateXMLRulePanelFx extends JPanel implements ActionListener {
	...
	private TextArea xpathQueryArea = new TextArea();
	private CodeEditorTextPaneFx codeEditorPane = new CodeEditorTextPaneFx();

	private static void appendLn(StringBuilder sb, String text) {
		sb.append(text).append(PMD.EOL);
	}

	public CreateXMLRulePanelFx(TextArea xpathQueryArea, CodeEditorTextPaneFx codeEditorPane) {
		super();
