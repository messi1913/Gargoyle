...
import com.kyj.fx.voeditor.visual.util.Formatter;
 ...
 *
 */
class XMLDiffFormatter implements Formatter {

	private static final Logger LOGGER = LoggerFactory.getLogger(XMLDiffFormatter.class);

	/**
	 * 
	 */
	public XMLDiffFormatter() {
	 ...
	 * @return
	 */
	public static XMLDiffFormatter newInstnace() {
		return new XMLDiffFormatter();
	}
