 ...
 *
 */
public class H2SchemaItemTree extends SchemaItemTree<String> {

	public H2SchemaItemTree(DatabaseItemTree<String> parent, String name) throws Exception {
		super(parent, name);
	}
	...
	public ObservableList<TreeItem<DatabaseItemTree<String>>> applyChildren(List<Map<String, Object>> items) throws Exception {
		...
		for (Map<String, Object> map : items) {
			...
			H2TableItemTree mysqlSchemaItemTree = new H2TableItemTree(this, tableName.toString());
