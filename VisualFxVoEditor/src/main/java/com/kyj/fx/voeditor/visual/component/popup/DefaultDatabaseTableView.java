 ...
 *
 */
@FXMLController(value = "DefaultDatabaseTableView.fxml", isSelfController = true)
public class DefaultDatabaseTableView extends BorderPane {

	private static final Logger LOGGER = LoggerFactory.getLogger(DefaultDatabaseTableView.class);
...
//				String driver = instance.get(ResourceLoader.DBMS + "." + dbms);
...
//				e.printStackTrace();
	...
	public DefaultDatabaseTableView() {

		FxLoader.loadRoot(this.getClass(), this, err -> {
