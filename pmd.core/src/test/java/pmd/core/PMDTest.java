...
//		String string = Files.toString(javaFile, Charset.forName("UTF-8"));
//		System.out.println(string);
		String[] args = new String[] { "-d",fileString, "-f", "xml", "-R", ruleSetFile, "-r", pmdReportFileName , "-version" , "1.8", "-language", "java" ,  "-P", "driver=jdbc.oracle,url=10.20.2.2,id=ccc,password=ccc" , "-debug" };
