...
public class PMDConfiguration extends AbstractConfiguration {
	...
	/**
	 * Prepend the specified classpath like string to the current ClassLoader of the configuration. If no ClassLoader is currently configured, the ClassLoader used to load the {@link PMDConfiguration}
